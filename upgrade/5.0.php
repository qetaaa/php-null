...
msgbox("info","Information", "<form action=\"index.php\" method=\"GET\">Upgrading database from version <b>5.0</b> to version <b>5.1</b> successfully completed.<br />Click Next to continue process upgrade script<br /><br /><input type=\"hidden\" name=\"next\" value=\"5.2\"><input class=\"edit\" type=\"submit\" value=\"Next ...\"></form>");
?>