...
msgbox("info","Information", "<form action=\"index.php\" method=\"GET\">Upgrading database from version <b>3.5</b> to version <b>3.7</b> successfully completed.<br />Click Next to continue process upgrade script<br /><br /><input type=\"hidden\" name=\"next\" value=\"3.7\"><input class=\"edit\" type=\"submit\" value=\"Next ...\"></form>");
?>