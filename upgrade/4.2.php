...
msgbox("info","Information", "<form action=\"index.php\" method=\"GET\">Upgrading database from version <b>4.2</b> to version <b>4.3</b> successfully completed.<br />Click Next to continue process upgrade script<br /><br /><input type=\"hidden\" name=\"next\" value=\"4.3\"><input class=\"edit\" type=\"submit\" value=\"Next ...\"></form>");
?>