...
msgbox("info","Information", "<form action=\"index.php\" method=\"GET\">Upgrading database from version <b>7.5</b> to version <b>8.0</b> successfully completed.<br />{$error_info}<br />Click Next to continue process upgrade script<br /><br /><input type=\"hidden\" name=\"next\" value=\"8.0\"><input class=\"edit\" type=\"submit\" value=\"Next ...\"></form>");
?>